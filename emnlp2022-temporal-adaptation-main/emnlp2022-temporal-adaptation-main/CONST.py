...
ROOT = "~\Downloads\emnlp2022-temporal-adaptation-main1\emnlp2022-temporal-adaptation-main\/" 

CLEX_EVENTS = {'2013_West_Texas_explosion-tweets_labeled.csv-all.txt', '2012_Typhoon_Pablo-tweets_labeled.csv-all.txt', '2013_Brazil_nightclub_fire-tweets_labeled.csv-all.txt', '2013_Bohol_earthquake-tweets_labeled.csv-all.txt', '2013_LA_airport_shootings-tweets_labeled.csv-all.txt', '2012_Costa_Rica_earthquake-tweets_labeled.csv-all.txt', '2013_Australia_bushfire-tweets_labeled.csv-all.txt', '2013_Alberta_floods-tweets_labeled.csv-all.txt', '2012_Colorado_wildfires-tweets_labeled.csv-all.txt', '2012_Guatemala_earthquake-tweets_labeled.csv-all.txt', '2013_Glasgow_helicopter_crash-tweets_labeled.csv-all.txt', '2012_Italy_earthquakes-tweets_labeled.csv-all.txt', '2012_Venezuela_refinery-tweets_labeled.csv-all.txt', '2013_Savar_building_collapse-tweets_labeled.csv-all.txt', '2013_Sardinia_floods-tweets_labeled.csv-all.txt', '2013_Boston_bombings-tweets_labeled.csv-all.txt', '2013_Typhoon_Yolanda-tweets_labeled.csv-all.txt', '2013_Colorado_floods-tweets_labeled.csv-all.txt', '2013_Queensland_floods-tweets_labeled.csv-all.txt', '2013_Russia_meteor-tweets_labeled.csv-all.txt', '2012_Philipinnes_floods-tweets_labeled.csv-all.txt', '2013_Manila_floods-tweets_labeled.csv-all.txt', '2013_Singapore_haze-tweets_labeled.csv-all.txt', '2013_NY_train_crash-tweets_labeled.csv-all.txt', '2013_Lac_Megantic_train_crash-tweets_labeled.csv-all.txt', '2013_Spain_train_crash-tweets_labeled.csv-all.txt'}
...
DATASET_MAP.update({clex_event:ROOT + "datasets/clex/" + clex_event for clex_event in CLEX_EVENTS})
